@if (!$Productswithoffersanddiscounts->isEmpty())
    <div id="desktop_content_Productswithoffersanddiscounts">
            ...
            <div class="container">
                <div class="row categoryheadlinetext d-flex align-items-center justify-content-end text-right">
                    <div class="col-6 d-flex align-items-center justify-content-start text-right">
                        <a href="{{ route('EcommerceProductsWithOffers') }}" class="Mediumfont decorationnone">
                ...
                <div class="row g-4 justify-content-center pt-3">
                    @foreach ($Productswithoffersanddiscounts as $Productwithofferanddiscount)
                        @php
                            $Product = $Products->firstWhere('product_id', $Productwithofferanddiscount->product_id);
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div
                                ...
                                <div class="product-image-container ratio ratio-1x1">
                                    <a href="{{ route('ProductDetails', $Productwithofferanddiscount->product_id) }}"
                                ...
                                <div class="product-info p-3 flex-grow-1 d-flex flex-column">
                                    ...
                                    <div
                                        ...
                                        @if ($Productwithofferanddiscount->ecommerceproduct_appearinthelistofoffers == '1')
                                ...
                                <div class="p-3 pt-0">
                                    ...
                                    @else
                                        <form method="post"
                                            action="{{ route('ProductDetailsPost', $Productwithofferanddiscount->product_id) }}"
                                            class="w-100">
                                            @csrf
                                            @method('post')
                                            <button type="submit"
    ...
    <div id="mobile_content_Productswithoffersanddiscounts">
