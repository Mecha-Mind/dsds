                ...
                <div class="row pt-5 pb-3">
                    <div class="col-3 m-auto">
                        <button class="btn apponwer_systemprimarybtn">
                            <i class="fas fa-vector-square pt-2 pl-2 "></i></button>

                        <a href="{{ route('EcommerceProductsWithOffersRow') }}" class="decorationnone Headlinecolor">
                            <button class="btn apponwer_systemprimarybtn">
                                <i class="fas fa-sliders-h pt-2 pl-2"></i></button>
                        </a>
                    </div>
                    ...
                    <div class="col-3 text-end">
                        <a href="{{ route('EcommerceAllProducts') }}" class="text-decoration-none">
...
<div id="mobile_content_EcommerceAllProductsproductsdivs">
    ...
    <div class="row py-3" style="padding: 16px;">
        <div class="col-12 col-md-3 d-flex justify-content-center align-items-center mb-2 mb-md-0">
            <a href="{{ route('EcommerceProductsWithOffersRow') }}" class="text-decoration-none Headlinecolor me-3">
                <button class="btn apponwer_systemprimarybtn">
                    <i class="fas fa-sliders-h fs-5"></i></button>
            </a>
            <button class="btn apponwer_systemprimarybtn">
                <i class="fas fa-vector-square fs-5 "></i></button>
        </div>
        ...
        <div class="col-12 col-md-3 d-flex justify-content-center align-items-center">
            <a href="{{ route('EcommerceAllProducts') }}" class="w-100">
